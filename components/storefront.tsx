      ...
      {page?.headerMode !== "hidden" && <header className="header">
        <div className="container header-inner">
          ...
          <div className="header-actions">
            <Link href="/account" className="icon-link" aria-label="My account"><CircleUserRound /></Link>
